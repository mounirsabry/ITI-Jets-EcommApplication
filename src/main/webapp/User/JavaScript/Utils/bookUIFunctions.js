...
const createBookCard = (book) => {
  ...
  bookCardDetails.append(createDetailElement(book.author, "author"), createDetailElement(book.genre, "genre"))
  ...
  if (book.discountedPercentage && book.discountedPercentage > 0) {
    ...
    bookCardDetails.appendChild(createDetailElement(`${book.price} EGP`, "price"))
  }
  ...
  function updateCard(updatedBook) {
    ...
    if (authorElement) authorElement.textContent = updatedBook.author || book.author
    if (genreElement) genreElement.textContent = updatedBook.genre || book.genre
    ...
    if (updatedBook.discountedPercentage && updatedBook.discountedPercentage > 0) {
      ...
      // No discount, just show regular price
      bookCardDetails.appendChild(createDetailElement(`${updatedBook.price} EGP`, "price"))
    }
  ...
  // Make the entire card clickable - Fixed to ensure proper event handling
