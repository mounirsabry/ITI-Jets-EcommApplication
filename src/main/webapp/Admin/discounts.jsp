<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% String adminUsername; HttpSession sessionObj=request.getSession(false); adminUsername=(String)
        ...
        <body>
                    ...
                    <div class="discounts-content">
                        ...
                        <div class="tab-content" id="discounts-tab">
                            <div class="action-bar">
                                ...
                                <button id="viewDiscountedBooksBtn" class="btn">View Discounted Books</button>
                        ...
                        <form id="bannerForm">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="bannerStartDate" name="bannerStartDate" required>
                                </div>
                                <div class="form-group">
                                    <label for="bannerEndDate">End Date*</label>
                                    <input type="date" id="bannerEndDate" name="bannerEndDate" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="bannerStatus">Status</label>
                                <div class="toggle-switch">
                                    <input type="checkbox" id="bannerStatus" name="bannerStatus" checked>
                                    <label for="bannerStatus"></label>
                        ...
                        <form id="discountForm">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="discountStartDate" name="discountStartDate" required>
                                </div>
                                <div class="form-group">
                                    <label for="discountEndDate">End Date*</label>
                                    <input type="date" id="discountEndDate" name="discountEndDate" required>
                                </div>
                            </div>
                            <div class="form-actions">
            ...
            <!-- View Discounted Books Modal -->
            <div id="discountedBooksModal" class="modal">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2>Books with Discounts</h2>
                        <span class="close">&times;</span>
                    </div>
                    <div class="modal-body">
                        <div class="table-container">
            ...
            <script src="JavaScript/discounts.js"></script>
        </body>
