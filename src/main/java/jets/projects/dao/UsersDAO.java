...
public class UsersDAO {
    ...
    public NormalUserBean userLogin(String email, String password) {return null;}
    public Integer register(NormalUserBean user) {return null;}
    public AdminBean adminLogin(int userID, String password) {return null;}
