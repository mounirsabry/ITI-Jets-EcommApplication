...
public class BookDto
{
    ...
    public BigDecimal getDiscountedPercentage() { return discountedPercentage; }
    public void setDiscountedPercentage(BigDecimal discountedPercentage) { this.discountedPercentage = discountedPercentage; }
    public List<BookImageDto> getImages() { return images; }
    public void setImages(List<BookImageDto> images) { this.images = images; }
